...
using TrainCore.Sessions;
using TrainCore.Web.Models.Account;
using TrainCore.Web.Views.Shared.Components.TenantChange;

namespace TrainCore.Web.Controllers
{
    public class AccountController : TrainCoreControllerBase
    {
